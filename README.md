...
[![Deploy on Vercel](https://img.shields.io/badge/Deploy-Vercel-black?logo=vercel)](https://ai-drama-studio.vercel.app)
[![Next.js 16](https://img.shields.io/badge/Next.js-16-black?logo=next.js)](https://nextjs.org/)
[![TypeScript](https://img.shields.io/badge/TypeScript-5-blue?logo=typescript)](https://www.typescriptlang.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)

> 基于 [huobao-drama](https://github.com/chatfire-AI/huobao-drama) 二次开发，项目名为 **ai-drama-studio**，使用 Next.js 16 + 多AI供应商架构 构建。
...
```bash
# 克隆仓库
git clone https://github.com/dav-niu474/ai-drama-studio.git
cd ai-drama-studio
