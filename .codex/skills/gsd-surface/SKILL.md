...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/Projects/DramaStudio/.codex/.gsd-surface.json`
(sibling to `F:/Projects/DramaStudio/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/Projects/DramaStudio/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`F:/Projects/DramaStudio/.codex/skills`).
...
`F:/Projects/DramaStudio/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `F:/Projects/DramaStudio/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/Projects/DramaStudio/.codex/.gsd-surface.json`
Install profile marker: `F:/Projects/DramaStudio/.codex/.gsd-profile`
Skill dirs: `F:/Projects/DramaStudio/.codex/skills/gsd-*/`
Engine module: `F:/Projects/DramaStudio/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `F:/Projects/DramaStudio/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
