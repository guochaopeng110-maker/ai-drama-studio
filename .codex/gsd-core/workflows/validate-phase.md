...
```
Agent(
  prompt="Read F:/Projects/DramaStudio/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/Projects/DramaStudio/.codex/gsd-core/templates/VALIDATION.md`
