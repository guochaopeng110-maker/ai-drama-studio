...
```markdown
Read F:/Projects/DramaStudio/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/Projects/DramaStudio/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/Projects/DramaStudio/.codex/agents/gsd-ui-checker.md for instructions.
