...
Key references:
- @F:/Projects/DramaStudio/.codex/gsd-core/references/ui-brand.md (display patterns)
- @F:/Projects/DramaStudio/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @F:/Projects/DramaStudio/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="F:/Projects/DramaStudio/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "F:/Projects/DramaStudio/.codex/gsd-core/USER-PROFILE.md" "F:/Projects/DramaStudio/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at F:/Projects/DramaStudio/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `F:/Projects/DramaStudio/.codex/gsd-core/references/user-profiling.md`
...
Reference: @F:/Projects/DramaStudio/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to F:/Projects/DramaStudio/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to F:/Projects/DramaStudio/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at F:/Projects/DramaStudio/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at F:/Projects/DramaStudio/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to F:/Projects/DramaStudio/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="F:/Projects/DramaStudio/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    F:/Projects/DramaStudio/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   F:/Projects/DramaStudio/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.codex/AGENTS.md>
  ✓ Global AGENTS.md        F:/Projects/DramaStudio/.codex/AGENTS.md
```
