...
ones). Reference: @F:/Projects/DramaStudio/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / F:/Projects/DramaStudio/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "F:/Projects/DramaStudio/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "F:/Projects/DramaStudio/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @F:/Projects/DramaStudio/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @F:/Projects/DramaStudio/.codex/gsd-core/templates/spec.md.
