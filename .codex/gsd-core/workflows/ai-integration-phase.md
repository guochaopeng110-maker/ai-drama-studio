...
<required_reading>
@F:/Projects/DramaStudio/.codex/gsd-core/references/ai-frameworks.md
@F:/Projects/DramaStudio/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read F:/Projects/DramaStudio/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "F:/Projects/DramaStudio/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read F:/Projects/DramaStudio/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read F:/Projects/DramaStudio/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read F:/Projects/DramaStudio/.codex/agents/gsd-eval-planner.md for instructions.
