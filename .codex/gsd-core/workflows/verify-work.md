...
<template>
@F:/Projects/DramaStudio/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@F:/Projects/DramaStudio/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `F:/Projects/DramaStudio/.codex/gsd-core/workflows/transition.md`.
...
- Follow @F:/Projects/DramaStudio/.codex/gsd-core/workflows/diagnose-issues.md
