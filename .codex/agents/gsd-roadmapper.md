...
Reference full template: `F:/Projects/DramaStudio/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/Projects/DramaStudio/.codex/gsd-core/templates/state.md`.
