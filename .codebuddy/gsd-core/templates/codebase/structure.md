...
- Usage: Reference from command with `@F:/Projects/DramaStudio/.codebuddy/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to F:/Projects/DramaStudio/.codebuddy/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to F:/Projects/DramaStudio/.codebuddy/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
