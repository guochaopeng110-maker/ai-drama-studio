...
<!-- For checkpoint task examples and patterns, see @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/checkpoints.md -->
...
See `F:/Projects/DramaStudio/.codebuddy/gsd-core/references/tdd.md` for TDD plan structure.
...
See `F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/user-setup.md` for full schema and examples
...
See `F:/Projects/DramaStudio/.codebuddy/gsd-core/workflows/verify-phase.md` for verification logic.
