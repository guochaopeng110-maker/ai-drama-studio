...
```
Agent(
  prompt="Read F:/Projects/DramaStudio/.codebuddy/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/VALIDATION.md`
