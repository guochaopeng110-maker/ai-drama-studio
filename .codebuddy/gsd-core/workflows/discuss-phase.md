...
<required_reading>
@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/domain-probes.md
@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/gate-prompts.md
@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "F:/Projects/DramaStudio/.codebuddy/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
...
```
Apply each entry in `activeHooks` per @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `analyze_phase`.
</step>
...
```
Apply each entry in `activeHooks` per @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `confirm_creation`.
</step>
