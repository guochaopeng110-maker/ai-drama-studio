...
- ./CLAUDE.md or ./.codebuddy/CLAUDE.md (if exists — project-specific guidelines)
...
- ./CLAUDE.md or ./.codebuddy/CLAUDE.md (if exists — follow project-specific guidelines)
...
- .planning/STATE.md (Project state)
- ./CLAUDE.md or ./.codebuddy/CLAUDE.md (Project instructions, if exists)
