...
ones). Reference: @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / F:/Projects/DramaStudio/.codebuddy.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "F:/Projects/DramaStudio/.codebuddy/gsd-core/bin/lib/edge-probe.cjs" \
  "F:/Projects/DramaStudio/.codebuddy/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/spec.md.
