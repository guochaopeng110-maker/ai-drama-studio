...
INSTALL_JS_GLOBAL="F:/Projects/DramaStudio/.codebuddy/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node F:/Projects/DramaStudio/.codebuddy/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
