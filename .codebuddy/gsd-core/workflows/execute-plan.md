...
@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/git-integration.md
</required_reading>
...
See `F:/Projects/DramaStudio/.codebuddy/gsd-core/references/tdd.md` for structure.
</tdd_plan_execution>
...
See F:/Projects/DramaStudio/.codebuddy/gsd-core/references/checkpoints.md for details.
</step>
...
If `NODE_REPAIR` is `true`: invoke `@./.codebuddy/gsd-core/workflows/node-repair.md` with:
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/summary.md`.
