...
Key references:
- @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/ui-brand.md (display patterns)
- @F:/Projects/DramaStudio/.codebuddy/agents/gsd-user-profiler.md (profiler agent definition)
- @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="F:/Projects/DramaStudio/.codebuddy/gsd-core/USER-PROFILE.md"
...
```bash
cp "F:/Projects/DramaStudio/.codebuddy/gsd-core/USER-PROFILE.md" "F:/Projects/DramaStudio/.codebuddy/USER-PROFILE.backup.md"
```
...
✓ Stores profile at F:/Projects/DramaStudio/.codebuddy/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `F:/Projects/DramaStudio/.codebuddy/gsd-core/references/user-profiling.md`
...
Reference: @F:/Projects/DramaStudio/.codebuddy/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to F:/Projects/DramaStudio/.codebuddy/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to F:/Projects/DramaStudio/.codebuddy/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at F:/Projects/DramaStudio/.codebuddy/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at F:/Projects/DramaStudio/.codebuddy/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to F:/Projects/DramaStudio/.codebuddy/CLAUDE.md"
...
```bash
BACKUP_PATH="F:/Projects/DramaStudio/.codebuddy/USER-PROFILE.backup.md"
```
...
Your profile:    F:/Projects/DramaStudio/.codebuddy/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   F:/Projects/DramaStudio/.codebuddy/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.codebuddy/CLAUDE.md>
  ✓ Global CLAUDE.md        F:/Projects/DramaStudio/.codebuddy/CLAUDE.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.codebuddy/CLAUDE.md` but may be overridden by config or `--output`.)
