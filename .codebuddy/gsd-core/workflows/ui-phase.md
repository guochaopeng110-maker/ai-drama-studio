...
```markdown
Read F:/Projects/DramaStudio/.codebuddy/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/Projects/DramaStudio/.codebuddy/agents/gsd-ui-checker.md for instructions.
