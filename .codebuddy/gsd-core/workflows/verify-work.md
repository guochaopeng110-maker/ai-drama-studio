...
<template>
@F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `F:/Projects/DramaStudio/.codebuddy/gsd-core/workflows/transition.md`.
...
- Follow @F:/Projects/DramaStudio/.codebuddy/gsd-core/workflows/diagnose-issues.md
