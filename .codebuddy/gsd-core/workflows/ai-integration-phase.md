...
<required_reading>
@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/ai-frameworks.md
@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read F:/Projects/DramaStudio/.codebuddy/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read F:/Projects/DramaStudio/.codebuddy/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read F:/Projects/DramaStudio/.codebuddy/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read F:/Projects/DramaStudio/.codebuddy/agents/gsd-eval-planner.md for instructions.
