...
---
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/Projects/DramaStudio/.codebuddy/.gsd-surface.json`
(sibling to `F:/Projects/DramaStudio/.codebuddy/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/Projects/DramaStudio/.codebuddy/skills/gsd-*/`.
...
(`F:/Projects/DramaStudio/.codebuddy`), NOT the skills sub-directory (`F:/Projects/DramaStudio/.codebuddy/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `F:/Projects/DramaStudio/.codebuddy` as `configDir`. The skill dirs themselves live at
`F:/Projects/DramaStudio/.codebuddy/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# CodeBuddy — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-F:/Projects/DramaStudio/.codebuddy}"
SCOPE="global"
...
(i.e. `F:/Projects/DramaStudio/.codebuddy/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/Projects/DramaStudio/.codebuddy/.gsd-surface.json`
Install profile marker: `F:/Projects/DramaStudio/.codebuddy/.gsd-profile`
Skill dirs: `F:/Projects/DramaStudio/.codebuddy/skills/gsd-*/`
Engine module: `F:/Projects/DramaStudio/.codebuddy/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `F:/Projects/DramaStudio/.codebuddy/gsd-core/bin/lib/clusters.cjs`
</execution_context>
