...
Reference full template: `F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/Projects/DramaStudio/.codebuddy/gsd-core/templates/state.md`.
