...
<reference>
@F:/Projects/DramaStudio/.codebuddy/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `F:/Projects/DramaStudio/.codebuddy/gsd-core/references/user-profiling.md` to load:
