...
// hardcode the canonical path `@~/.codebuddy/gsd-core/...` (references, workflows,
...
// `~/.codebuddy/gsd-core/` is never created and every @-include resolves to
...
// `~/.codebuddy/gsd-core/` exists and its immutable subdirs (bin, contexts,
...
// are the directories `@~/.codebuddy/gsd-core/<subdir>/...` includes point into.
...
/**
 * Ensure the canonical `~/.codebuddy/gsd-core/` path exposes the bundled subdirs.
 *
